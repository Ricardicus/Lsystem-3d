...
export function LevolveSystem(lsystem, axiom, axiomRules) {
   ...
   for (var i = 0; i < lstring.length; i++) {
      ...
      if (type == "move" || type == "rotate" || type == "penUp" || type == "penDown") {
         ...
         if (symbol.axiom == axiom) {
            ...
            for (var q = 0; q < rules.length; q++) {
               ...
               } else if (innerType == "move" || innerType == "rotate" || innerType == "penUp" || innerType == "penDown") {
   ...
   for (var i = 0; i < lstring.length; i++) {
      ...
      if (isArr) {
         ...
         if (type == "pop") {
            ...
            result += "[";
         } else if (type == "move" || type == "rotate" || type == "penUp" || type == "penDown") {
            if (type == "move") {
               result += "mov";
            } else if (type == "rotate") {
               result += "rot";
