...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c46 = function(left, right) { return parseFloat(left.join("") + "." +   right.join("")); },
      peg$c47 = function(left, right) { return -1*parseFloat(left.join("") + "." +   right.join("")); },
      ...
      peg$c64 = /^[ABCDEFGH]/,
      peg$c65 = peg$classExpectation(["A", "B", "C", "D", "E", "F", "G", "H"], false, false),
